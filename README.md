...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `80.6µs` | `791.0µs` |
| [Day 2](./src/bin/02.rs) | `67.8µs` | `-` |
| [Day 4](./src/bin/04.rs) | `75.1µs` | `72.4µs` |
| [Day 5](./src/bin/05.rs) | `66.2µs` | `114.9µs` |
| [Day 6](./src/bin/06.rs) | `449.0ns` | `471.0ns` |
| [Day 7](./src/bin/07.rs) | `183.3µs` | `184.9µs` |
| [Day 8](./src/bin/08.rs) | `-` | `-` |
