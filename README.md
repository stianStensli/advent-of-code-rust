...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `84.3µs` | `764.9µs` |
| [Day 4](./src/bin/04.rs) | `75.6µs` | `77.2µs` |
| [Day 5](./src/bin/05.rs) | `64.1µs` | `115.2µs` |
| [Day 6](./src/bin/06.rs) | `521.0ns` | `500.0ns` |
| [Day 7](./src/bin/07.rs) | `188.7µs` | `-` |
