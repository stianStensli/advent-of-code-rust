...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `93.1µs` | `803.0µs` |
| [Day 4](./src/bin/04.rs) | `74.9µs` | `70.2µs` |
| [Day 5](./src/bin/05.rs) | `62.5µs` | `111.8µs` |
| [Day 6](./src/bin/06.rs) | `415.0ns` | `473.0ns` |
| [Day 7](./src/bin/07.rs) | `177.0µs` | `179.1µs` |
